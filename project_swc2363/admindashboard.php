...
<body>
    ...
    <section class="admin-dashboard">
        ...
        <form id="online-class-form">
            ...
            <input type="number" id="semester" placeholder="Enter semester number" required>
    ...
    <script>
        ...
        function addMeeting() {
            ...
            if (!courseName || !subjectName || !lecturerName || !semester || !className || !classDate || !classTimeStart || !classTimeEnd || !googleMeetLink) {
        ...
        function displayMeetings() {
            ...
            meetings.forEach((meeting) => {
                ...
                meetingDiv.innerHTML = `
                    ...
                    <p><strong>Semester:</strong> ${meeting.semester}</p> <!-- Added Semester -->
        ...
        function editMeeting(meetingId) {
            ...
            if (meeting) {
                ...
                document.getElementById("semester").value = meeting.semester;
